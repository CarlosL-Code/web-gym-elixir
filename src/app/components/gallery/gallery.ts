...
export class Gallery {
  images = [
    ...
    { src: 'assets/images/entrenamiento-funcional.jpg', alt: 'Entrenamiento Funcional', span: 'col-span-1 row-span-1 md:row-span-2' },
    { src: 'assets/images/zona-de-boxeo.jpg', alt: 'Zona de Boxeo', span: 'col-span-1 row-span-1 md:row-span-1' },
